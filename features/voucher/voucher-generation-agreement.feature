...
Scenario Outline: La generazione del Voucher va a buon fine quando il fruitore perde e poi riottiene un attributo certificato necessario all’utilizzo dell’EService
    ...
    Given la richiesta di fruizione è passata in stato "MISSING_CERTIFIED_ATTRIBUTE"
...
@voucher_generation_agreement8 @TEST
...
@voucher_generation_agreement9 @TEST
...
@voucher_generation_agreement10 @TEST
