...
Feature: Listing attributi verificati posseduti dal richiedenti
  Tutti gli utenti autenticati possono leggere la lista degli attributi verificati posseduti 
  ...
  Scenario Outline: Per un attributo precedentemente verificato da un altro aderente, alla richiesta di lettura, va a buon fine
    ...
    When l'utente richiede una operazione di listing degli attributi verificati posseduti
