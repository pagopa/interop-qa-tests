@agreement_consumer_listing
Feature: Listing erogatori lato fruitore
  Tutti gli utenti autenticati possono ottenere la lista degli erogatori degli e-service per cui hanno sottoscritto una richiesta

  @agreement_consumer_listing1
