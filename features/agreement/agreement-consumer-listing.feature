...
Feature: Listing erogatori con richieste di fruizione
  ...
  Scenario Outline: A fronte di 4 fruitori, restituisce solo i primi 3 risultati
    ...
    When l'utente richiede una operazione di listing degli erogatori dei propri e-service limitata ai primi 3
    Then si ottiene status code 200 e la lista di 3 erogatori
