...
Feature: Lettura di un documento
  ...
  @document_read2
  Scenario Outline: Per un e-service che ha un solo descrittore, il quale è in qualsiasi stato NON DRAFT (PUBLISHED, SUSPENDED, DEPRECATED, ARCHIVED), alla richiesta di recupero di un documento precedentemente caricato da parte di un Privato, ottiene il documento
    Given l'utente è un "<ruolo>" di "Privato"
