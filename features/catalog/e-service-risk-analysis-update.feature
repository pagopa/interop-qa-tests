...
Feature: Aggiornamento di un'analisi del rischio ad un e-service
  ...
  Scenario Outline: Per un e-service creato con mode="RECEIVE", il quale non ha descrittori, è possibile aggiornare un'analisi del rischio precedentemente creata. L'analisi del rischio deve essere ben formattata ma non necessariamente completamente compilata. La richiesta va a buon fine se è un utente autorizzato
